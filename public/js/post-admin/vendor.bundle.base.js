        ...
        Dn = function () {
            ...
            return t.refresh = function () {
                ...
                t._activate = function (e) {
                    ...
                    n.hasClass(gn) ? (n.closest(Cn).find(Sn).addClass(_n), n.addClass(_n)) : (n.addClass(_n), n.parents(pn).prev(vn + ", " + En).addClass(_n), n.parents(pn).prev(yn).children(vn).addClass('')), g(this._scrollElement).trigger(dn.ACTIVATE, {
                        relatedTarget: e
                    })
                },
                t._clear = function () {
