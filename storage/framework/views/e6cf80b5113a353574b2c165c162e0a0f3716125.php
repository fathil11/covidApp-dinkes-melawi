        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item <?php echo e(Request::is('admin/content/post') ? 'active' : ''); ?>">
...
<?php /**PATH /mnt/e/Web/dinkes-melawi-corona/resources/views/layouts/post-admin.blade.php ENDPATH**/ ?>