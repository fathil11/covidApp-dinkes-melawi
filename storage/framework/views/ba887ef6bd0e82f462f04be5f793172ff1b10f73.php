                    ...
                    <td>
                        ...
                        <div class="row">
                            <div class="flexbox">
                                ...
                                <div class="col">
                                    <form action="/admin-perbatasan/delete/<?php echo e($person->id); ?>" method="post"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.perbatasan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/e/Web/dinkes-melawi-corona/resources/views/perbatasan/kelolaOrang.blade.php ENDPATH**/ ?>