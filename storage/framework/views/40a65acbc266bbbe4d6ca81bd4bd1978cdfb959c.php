                    ...
                    <table class="table table-hover table-responsive-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>1</td>
                                <td>Sokan</td>
                                <td><?php echo e(PublicController::getDistrictStat('0', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('0', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('0', '5')); ?></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>Tanah Pinoh Barat</td>
                                <td><?php echo e(PublicController::getDistrictStat('1', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('1', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('1', '5')); ?></td>
                            </tr>
                            <tr class="bg-warning">
                                <td>3</td>
                                <td>Tanah Pinoh</td>
                                <td><?php echo e(PublicController::getDistrictStat('2', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('2', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('2', '5')); ?></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>Sayan</td>
                                <td><?php echo e(PublicController::getDistrictStat('3', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('3', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('3', '5')); ?></td>
                            </tr>
                            <tr class="bg-warning">
                                <td>5</td>
                                <td>Belimbing Hulu</td>
                                <td><?php echo e(PublicController::getDistrictStat('4', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('4', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('4', '5')); ?></td>
                            </tr>
                            <tr class="bg-warning">
                                <td>6</td>
                                <td>Belimbing</td>
                                <td><?php echo e(PublicController::getDistrictStat('5', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('5', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('5', '5')); ?></td>
                            </tr>
                            <tr class="bg-warning">
                                <td>7</td>
                                <td>Pinoh Selatan</td>
                                <td><?php echo e(PublicController::getDistrictStat('6', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('6', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('6', '5')); ?></td>
                            </tr>
                            <tr class="bg-danger">
                                <td>8</td>
                                <td>Nanga Pinoh</td>
                                <td><?php echo e(PublicController::getDistrictStat('7', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('7', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('7', '5')); ?></td>
                            </tr>
                            <tr>
                                <td>9</td>
                                <td>Pinoh Utara</td>
                                <td><?php echo e(PublicController::getDistrictStat('8', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('8', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('8', '5')); ?></td>
                            </tr>
                            <tr>
                                <td>10</td>
                                <td>Ella Hilir</td>
                                <td><?php echo e(PublicController::getDistrictStat('9', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('9', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('9', '5')); ?></td>
                            </tr>
                            <tr>
                                <td>11</td>
                                <td>Menukung</td>
                                <td><?php echo e(PublicController::getDistrictStat('10', '0')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('10', '2')); ?></td>
                                <td><?php echo e(PublicController::getDistrictStat('10', '5')); ?></td>
                            </tr>
                        </tbody>
                        </tbody>
                    </table>
                ...
                <div class="col-md-12 mt-4" id="hubungikami">
                    <div class="card bg-yellow">
                        <div class="card-body text-center">
                            ...
                            <img class="lazyload img-fluid mt-3" data-src="<?php echo e(asset('img/dokter.png')); ?>"
