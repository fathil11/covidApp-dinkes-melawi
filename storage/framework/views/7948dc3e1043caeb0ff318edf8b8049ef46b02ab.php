...
<body>
    <header class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
            <a class="navbar-brand font-weight-reguler" href="/">
                <img src="<?php echo e(asset('img/logoMelawi.png')); ?>" width="30px" class="mr-lg-2" alt="">
                DINKES MELAWI
            </a>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="row">
                        <div class="col-md-2 text-center text-md-left">
                            <img class="" src="<?php echo e(asset('img/logoMelawi.png')); ?>" width="40px" alt="" srcset="">
                        </div>
    ...
    <script src="<?php echo e(asset('js/bootstrap.js')); ?>">
    </script>
