...
<div class="row">
    <form action="/admin-perbatasan/store" method="post" autocomplete="off">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.perbatasan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/e/Web/dinkes-melawi-corona/resources/views/perbatasan/index.blade.php ENDPATH**/ ?>