    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 mb-4 mb-md-0">
            <div class="card">
                ...
                <img src="<?php echo e(asset('storage/blog-banners/9mJNHqz1enDpojLHDFBjV5I9ws39E7uOMJIBHwcj.jpeg')); ?>"
        ...
        <div class="col-md-4 col-sm-6 mb-4 mb-md-0">
            <div class="card">
                ...
                <img src="<?php echo e(asset('storage/blog-banners/IMG_8480.JPG')); ?>" class="card-img-top" alt="...">
                <div class="card-body">
                    <h4 class="card-title">Hari ini telah terjadi di Posko 2010</h4>
                </div>
            </div>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/e/Web/dinkes-melawi-corona/resources/views/public/allPost.blade.php ENDPATH**/ ?>